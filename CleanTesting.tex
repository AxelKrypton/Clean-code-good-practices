...
\begin{frame}{It is a discipline}
    ...
    \end{itemize}
    \begin{varblock}{example}[0.75\textwidth]{Eventually}
...
\begin{frame}{Wrapping up the advice}
    \begin{onlyenv}<1>
        \begin{enumerate}
            \item «I do not have time to write tests» does not make any sense!
            \item Writing tests is an inseparable part of the code development
            \item Tests are the only way to change code still ensuring its correctness
            \item Test the behaviour, not the implementation
    ...
    \begin{onlyenv}<2>
        \begin{center}
            ...
            If this is not your reaction write now, it will be soon!
        \end{center}
    \end{onlyenv}
    \begin{onlyenv}<3>
        \begin{center}
